...
/**
 * Lambda class based on Hello class. Used to show Log4j on Lambda environment.
 *
 */
public class LambdaLog4j implements RequestHandler<MyPojo, String> {
    ...
    /**
     * Handler sample events. Logs Hello wordl message and JSON paramters that represents MyPojo class.
     *
